execute_test: City.o Connection.o DirectConnection.o Matrix.o DataBase.o execute_project_file.o RouteFinder.o FinderAlgorithm.o
	g++ -g -o project_test.out City.o Connection.o DirectConnection.o Matrix.o DataBase.o execute_project_file.o RouteFinder.o FinderAlgorithm.o
...
FinderAlgorithm_test: FinderAlgorithm_test.o City.o Connection.o DirectConnection.o Matrix.o DataBase.o FinderAlgorithm.o
	g++ -g -o FinderAlgorithm_test.out FinderAlgorithm_test.o City.o Connection.o DirectConnection.o Matrix.o DataBase.o FinderAlgorithm.o
...
FinderAlgorithm_test.o: FinderAlgorithm_test.cpp
	g++ -g -c FinderAlgorithm_test.cpp
